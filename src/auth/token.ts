import { guardedFetch, type FetchLike } from "../ga4/http.js";
...
function readTokenResponse(body: unknown, now: number): AccessToken {
...
export function createTokenProvider(
  ...
  async function exchange(signal?: AbortSignal): Promise<AccessToken> {
    const issuedAt = now();
